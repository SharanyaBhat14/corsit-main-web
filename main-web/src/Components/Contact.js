...
import Laptop from "../img/logo192.png";
  ...
  return (
    <div className="w-full bg-white py-16 px-4">
      <div className=" max-w-[1240px] mx-auto grid md:grid-cols-2">
        <iframe
          title="map"
          className=" rounded-lg h-80 w-96 ml-10 block lg:-ml-12"
        ...
        <div className="sm:flex flex-col justify-center ">
          ...
          <div className="flex flex-col justify-center my-4">
            <p className="text-2xl text-[#00df9a] font-bold">Email: </p>
            <div className="flex  ">
              <MdAlternateEmail className="mt-3 mr-1" size={30} />
              <p className="font-bold text-xl mt-2">corsit@sit.ac.in</p>
            </div>
          </div>

          <div className="flex flex-col justify-center my-8">
            <p className="text-2xl text-[#00df9a] font-bold">Call: </p>
            <div className="flex  ">
              <FiSmartphone className="mt-3 mr-1" size={30} />
              <p className="font-bold text-xl mt-2">6201928647</p>
            </div>
          </div>
        </div>
      </div>
